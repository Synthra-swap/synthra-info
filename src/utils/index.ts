...
import { ChainId, Currency, CurrencyAmount, Fraction, Percent, Token } from '@synthra-swap/sdk-core'
...
export function getExplorerLink(chainId: number, data: string, type: ExplorerDataType): string {
  const prefix = BLOCK_EXPLORER_PREFIXES[chainId] ?? 'https://explorer.uomi.ai'
