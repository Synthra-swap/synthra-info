...
import UOMI_LOGO_URL from '../assets/images/uomi-round.png'
...
export const UomiNetworkInfo: NetworkInfo = {
  chainId: 4386,
  id: SupportedNetwork.UOMI,
  route: 'uomi',
  name: 'Uomi',
  bgColor: 'rgb(190, 28, 166)',
  primaryColor: '#8e5ee8',
  secondaryColor: '#6114f1',
  imageURL: UOMI_LOGO_URL,
}
